...
export const SYMBOL_DEFS = {
  ...
  sym1: { id: "sym1", name: "Cage", kind: "base" },
  sym2: { id: "sym2", name: "Medallion", kind: "base" },
  sym3: { id: "sym3", name: "Dagger", kind: "base" },
  sym4: { id: "sym4", name: "Ring", kind: "base" },
  sym5: { id: "sym5", name: "Hand", kind: "base" },
  sym6: { id: "sym6", name: "Head", kind: "base" },
  sym7: { id: "sym7", name: "Totem", kind: "base" },
  sym8: { id: "sym8", name: "Ritual Warrior", kind: "base" },
  sym9: { id: "sym9", name: "Armored Warrior", kind: "base" },
  scatter: { id: "scatter", name: "Scatter", kind: "scatter" },
  blank: { id: "blank", name: "", kind: "blank" }
};
